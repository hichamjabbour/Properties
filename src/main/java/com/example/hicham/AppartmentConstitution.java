...
class AppartmentConstitution
{
    ...
    public String getNum_recepts() {
        return num_recepts;
    }

    public void setNum_recepts(String num_recepts) {
        this.num_recepts = num_recepts;
    }
}
