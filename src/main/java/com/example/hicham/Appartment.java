...
public class Appartment {
    ...
    public AppartmentConstitution getAppartment_constitution() {
        return appartment_constitution;
    }

    public void setAppartment_constitution(AppartmentConstitution appartment_constitution) {
    ...
    private Agent agent;
    private AppartmentConstitution appartment_constitution;
    ...
    public Appartment()
    {
        ...
        appartment_constitution = new AppartmentConstitution();
    }
